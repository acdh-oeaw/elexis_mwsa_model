...
with open('models/de_all_features_swapRandomForestClassifier20200318-1300.pickle', 'rb') as pickle_file:
    ...
    german_predicted.to_csv('german_result_swap.csv',sep='\t', index = False)
