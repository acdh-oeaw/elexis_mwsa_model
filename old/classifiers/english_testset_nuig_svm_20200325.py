...
feats = feature_extractor.extract(data, feats_to_scale = ['similarities', 'len_diff', 'pos_diff', 'max_depth_deptree_1', 'max_depth_deptree_2', 'synset_count_1','synset_count_2', 'target_word_synset_count'])
x_trainset, x_testset = model_trainer.split_data(feats, 0.0)


with open('models/en_nuig_svmVotingClassifier20200325-1321.pickle', 'rb') as pickle_file:
    ...
    german_predicted.to_csv('english_nuig_svm_20200325.csv',sep='\t', index = False)
