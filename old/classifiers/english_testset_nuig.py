...
with open('models/en_nuigRandomForestClassifier20200318-2200.pickle', 'rb') as pickle_file:
    ...
    german_predicted.to_csv('english_nuig.csv',sep='\t', index = False, header=False)
