...
with open('models/de_all_features_nonebalanceRandomForestClassifier20200316-1214.pickle', 'rb') as pickle_file:
    ...
    german_predicted.to_csv('german_result.csv',sep='\t', index = False)
