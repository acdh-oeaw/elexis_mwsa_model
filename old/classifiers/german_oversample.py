...
if __name__ == '__main__':
    ...
    german_config = ClassifierConfig('de_core_news_md', "german", 'data/train', balancing_strategy="oversampling",testset_ratio=0.0, logger = 'de_all_features_oversampling')
    ...
    model_trainer.add_estimators([svm_model, rf])
