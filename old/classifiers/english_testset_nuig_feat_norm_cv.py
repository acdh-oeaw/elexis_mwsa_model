...
with open('models/en_nuig_overfithandlingRandomForestClassifier20200326-0210.pickle', 'rb') as pickle_file:
    ...
    german_predicted.to_csv('english_nuig_20200326.csv',sep='\t', index = False)
